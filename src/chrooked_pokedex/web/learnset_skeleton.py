...
SIGNATURE_MOVES: frozenset[str] = frozenset({
    ...
    "clanging scales", "dragon energy", "rage fist", "sparkling aria", "drum beating", "sappy seed", "searing shot", "thunderous kick", "aeroblast", "chatter", "spirit break", "magical torque", "barb barrage", "hydro steam", "origin pulse", "armor cannon",
