...
if DEF(FAITHFUL)
	...
	move CUT,             EFFECT_NORMAL_HIT,         60, STEEL,     100, 20,   0, PHYSICAL
endc
...
endc
	...
	move SLASH,           EFFECT_NORMAL_HIT,         60, NORMAL,    100, 20,   0, PHYSICAL
	...
	move CURSE,           EFFECT_CURSE,               0, GHOST,       0, 10,   0, STATUS
	...
	move ASTONISH,        EFFECT_FLINCH_HIT,         40, GHOST,     100, 10,  30, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move OCTAZOOKA,       EFFECT_ACCURACY_DOWN_HIT, 100, WATER,      90, 10,  50, SPECIAL
endc
	...
	move POWER_GEM,       EFFECT_NORMAL_HIT,         90, ROCK,      100, 15,   0, SPECIAL
...
endc
	...
	move AURA_SPHERE,     EFFECT_ALWAYS_HIT,         80, FIGHTING,    0, 20,   0, SPECIAL
